...
<svelte:head><title>StreamBridge — One chat across every platform</title><meta name="description" content="Relay livestream chat between Discord, Twitch, YouTube, Kick, and Social Stream Ninja." /></svelte:head>
<section class="hero">
...
<section class="section" id="features">
	...
	<div class="feature-grid">
		...
		<article><b>03</b><h3>Works standalone</h3><p>Create a bridge workspace without installing the bot in a Discord server. Discord is an option, not a requirement.</p></article>
		<article><b>04</b><h3>SSN-aware</h3><p>Use Social Stream Ninja when it is available and keep direct platform connections ready when it is not.</p></article>
		<article><b>05</b><h3>Your identities</h3><p>Sign in with Discord, Google, Twitch, or Kick and link them to one StreamBridge account.</p></article>
